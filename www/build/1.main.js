...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jQuery__ = __webpack_require__(353);
...
var MessagesPage = (function () {
    function MessagesPage(navCtrl, navParams, afd, storage) {
    ...
    MessagesPage.prototype.denyFriend = function (message) {
        var index = this.MessageData.indexOf(message);
        if (index > -1) {
            __WEBPACK_IMPORTED_MODULE_4_jQuery__(index).html('Denied');
        }
        ...
        //   username: null
        // })
        alert(JSON.stringify(__WEBPACK_IMPORTED_MODULE_4_jQuery__('#' + this.clickedID).html('Denied')));
    };
    MessagesPage.prototype.approveFriend = function (uid) {
        this.myID = localStorage.getItem('uid');
        ...
        __WEBPACK_IMPORTED_MODULE_4_jQuery__('.confirmation').html('Approved');
    };
