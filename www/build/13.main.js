...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_jQuery__ = __webpack_require__(353);
...
var MessagesPage = (function () {
    ...
    MessagesPage.prototype.ionViewWillEnter = function () {
        ...
        if (__WEBPACK_IMPORTED_MODULE_5_jQuery__('ion-item').length < 1) {
            __WEBPACK_IMPORTED_MODULE_5_jQuery__('ion-list').prepend('<p class="noMessages">No Messages</p>');
        }
        else {
            __WEBPACK_IMPORTED_MODULE_5_jQuery__('.noMessages').remove();
        }
    };
